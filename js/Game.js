class Game {
  ...
  start() {
    ...
    //Assumindo 'algumas' posições fixas dos obstáculos
  ...
  showFuelBar() {
    ...
    // Retângulo branco por baixo
    fill("white");
    rect(width / 2 - 100, height - player.positionY - 270, 185, 20);
    // Retângulo amarelo por cima
    fill("#ffc400");
